...
interface WritableStream extends EventEmitter {
    ...
    namespace NodeJsMvc {
        namespace Controller {
            ...
            namespace Action {
                type OptionCapture = (request: SGAppsServerRequest, response: SGAppsServerResponse, server: SGAppsServer, controller: SGAppsServer.NodeJsMvc.Controller, action: SGAppsServer.NodeJsMvc.action) => void;
                type Options = {
                    public: boolean;
                    postData: boolean;
                    maxPostSize: number;
